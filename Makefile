...
.PHONY: all help \
        ...
        events-deploy events-verify events-webhook-secret events-webhook-secret-rotate \
...
pipeline-verify: ## Verify pipeline resources are present
...
events-verify: ## Verify events resources are present
